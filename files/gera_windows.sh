...
apt-get install --install-recommends -y ltsp ubuntu-desktop gdm3 nano gedit vim net-tools curl
...
echo '[6.3] Configurando SSH...'
apt-get install -y openssh-server
ssh-keygen -A
systemctl enable ssh

echo '[6.4] Configurando epoptes...'
epoptes-client -c

echo '[6.5] Definindo configurações DConf...'
...
echo '[6.11] Desmontagem como serviço'
